...
dd if=DiagROM.bin of=DiagROM.rom bs=1024 skip=6144 #15872
...
cp DiagROM.rom DiagCART.rom
dd if=/dev/zero of=DiagCART.rom bs=1 count=1 seek=1064959
printf "100000: 91 00 05 00 23 00 02 " | xxd -r - DiagCART.rom
